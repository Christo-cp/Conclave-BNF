...
export const api = {
  ...
  rejectAssignment: (assignmentId: string, reason: string) => request<{ id: string; status: string }>(`/ambulance-assignments/${assignmentId}/reject`, { method: 'POST', body: JSON.stringify({ reason }) }),
