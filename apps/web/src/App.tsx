...
const fallbackAmbulances: Candidate[] = [
  { code: 'AMB-002', score: 0.93, rank: 1, eligible: true, reasons: [], eta_s: 420, equipment: ['TRAUMA_KIT', 'VENTILATOR', 'OXYGEN'], data_mode: 'SIMULATED', age_s: 5 },
  { code: 'AMB-001', score: null, rank: null, eligible: false, reasons: ['MISSING_EQUIPMENT:VENTILATOR'], eta_s: 360, equipment: ['TRAUMA_KIT', 'OXYGEN'], data_mode: 'SIMULATED', age_s: 5 },
  { code: 'AMB-003', score: null, rank: null, eligible: false, reasons: ['UNAVAILABLE', 'ACTIVE_MISSION'], eta_s: 300, equipment: ['TRAUMA_KIT', 'VENTILATOR'], data_mode: 'SIMULATED', age_s: 5 },
  { code: 'AMB-005', score: null, rank: null, eligible: false, reasons: ['GPS_STALE'], eta_s: 540, equipment: ['TRAUMA_KIT', 'VENTILATOR', 'OXYGEN'], data_mode: 'SIMULATED', age_s: 120 },
]

const fallbackHospitals: HospitalCandidate[] = [
  { code: 'H-003', score: 0.88, rank: 1, eligible: true, reasons: [], eta_s: 600, resources: { ICU: 1, VENTILATOR: 1 }, data_mode: 'SIMULATED', age_s: 8 },
  { code: 'H-004', score: 0.81, rank: 2, eligible: true, reasons: [], eta_s: 660, resources: { ICU: 1, VENTILATOR: 1 }, data_mode: 'SIMULATED', age_s: 8 },
  { code: 'H-001', score: null, rank: null, eligible: false, reasons: ['MISSING_CAPABILITY:ICU'], eta_s: 480, resources: { ICU: null }, data_mode: 'SIMULATED', age_s: 8 },
  { code: 'H-006', score: null, rank: null, eligible: false, reasons: ['RESOURCE_UNAVAILABLE:ICU'], eta_s: 720, resources: { ICU: 0 }, data_mode: 'SIMULATED', age_s: 8 },
]
